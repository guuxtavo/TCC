...
export function Sidebar() {
   ...
   return (
      <>
         ...
         {isConfirmModalOpen && <ConfirmModal logout={logout} text="Tem certeza que deseja sair?" onClose={openConfirmModal} />}
         <aside className="w-[22%] 2xl:w-[20%] max-h-max bg-g-red-600">
            <div className="w-full h-full flex flex-col">
               ...
               <div className="h-14 py-4 mb-5 flex gap-5 justify-center items-center text-white bg-slate-800 hover:cursor-pointer hover:scale-105" onClick={openConfirmModal} >
